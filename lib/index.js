...
var _MuiPickersUtilsProvider2 = _interopRequireDefault(
  _MuiPickersUtilsProvider
);
...
var makePicker = function makePicker(PickerComponent) {
  var _makePicker = (function (_Component) {
    ...
    function _makePicker() {
      ...
      return _possibleConstructorReturn(
        this,
        (_makePicker.__proto__ || Object.getPrototypeOf(_makePicker)).apply(
          this,
          arguments
        )
      );
  ...
  _makePicker.propTypes = {
    ...
    providerOptions: _propTypes2.default.shape({
      ...
      locale: _propTypes2.default.oneOfType([
...
var DateInput = (exports.DateInput = (0, _raCore.addField)(
  makePicker(_materialUiPickers.DatePicker)
));
var TimeInput = (exports.TimeInput = (0, _raCore.addField)(
  makePicker(_materialUiPickers.TimePicker)
));
var DateTimeInput = (exports.DateTimeInput = (0, _raCore.addField)(
  makePicker(_materialUiPickers.DateTimePicker)
));
